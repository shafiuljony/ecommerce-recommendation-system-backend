                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" @if(empty($coupon['id'])) action="{{ url('admin/add-edit-coupon') }}" @else action="{{ url('admin/add-edit-coupon/'.$coupon['id']) }}" @endif method="post" enctype="multipart/form-data">@csrf
                    ...
                    <div class="form-group">
                      ...
                      <span>
                        <input type="radio" name="coupon_type" value="Multipule Times" checked>&nbsp;&nbsp;Multipule Times&nbsp;&nbsp;
                    ...
                    <div class="form-group">
                      ...
                      <span>
                        ...
                        <input type="radio" name="amount_type" value="Fixed">&nbsp;&nbsp;Fixed&nbsp;&nbsp;(in BDT or USD)&nbsp;
                      </span>
                    </div>
                    <div class="form-group">
                      <label for="amount">Amount</label>
                      <input type="text" class="form-control" id="amount" placeholder="Enter Amount" name="amount" require>
                    </div>    
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" id="expiry_date" placeholder="Enter Expiry Date" name="expiry_date" require>
                    </div>  
