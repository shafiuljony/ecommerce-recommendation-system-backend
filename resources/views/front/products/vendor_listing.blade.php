        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-12">
                ...
                <div class="page-bar clearfix">
                    ...
                    <!-- Toolbar Sorter 1  -->
                    <?php /*<form name="sortProducts" id="shortProducts" >
                ...
                @if(isset($_GET['sort']))
                    <div class="mt-5 mb-5 ">{{ $vendorProducts->appends(['sort'=>$_GET['sort']])->links() }}</div>
                @else
                <div class="mt-5 mb-5 ">{{$vendorProducts->links()}}</div>
                @endif
                <!-- Row-of-Product-Container /- -->
            </div>
            <!-- Shop-Right-Wrapper /- -->
