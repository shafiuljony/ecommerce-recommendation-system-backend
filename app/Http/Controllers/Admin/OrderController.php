...
class OrderController extends Controller
{
    ...
    public function updateOrderStatus(Request $request){
        if($request->isMethod('post')){
            ...
            if(!empty($data['courier_name'])&&!empty($data['tracking_number'])){
                ...
                $message->to($email)->subject('Order Status Updated - Anon.com');
                });
            }else{
                // Send Order Status Update Email
                $email = $deliveryDetails['email'];
    ...
    public function updateOrderItemStatus(Request $request){
        if($request->isMethod('post')){
            ...
            OrdersProduct::where('id',$data['order_item_id'])->update(['order_item_status'=>$data['order_item_status']]);
            ...
            <header class="clearfix">
                <div class="container">
                    <div class="company-address">
                        <h2 class="title">ANON BD</h2>
                        <p>
                            O R Nizam Road, GEC,<br>
                    ...
                    <div class="company-contact">
                        ...
                        <div class="email right">
                            ...
                            <a href="mailto:anon@ecom.com.bd">anon@ecom.com.bd</a>
                            <span class="helper"></span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="details clearfix">
                        ...
                        <div class="data right">
                            ...
                            <div class="date">
                                ...
                                Order Amount: BDT '.$orderDetails['grand_total'].'<br>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        foreach($orderDetails['orders_products'] as $product){
                            $invoiceHTML .= '<tr>
                                ...
                                <td class="total">BDT '.$product['product_price'].'</td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    if($orderDetails['coupon_amount']>0){
                                        $invoiceHTML .=  '<td class="total">BDT '.$orderDetails['coupon_amount'].'</td>';
                                    }else{
                                        $invoiceHTML .=  '<td class="total">BDT 0</td>';
                                    }
                                    $invoiceHTML .=  '</tr>
                                <tr>
                                    <td class="desc"></td>
                                    ...
                                    <td class="total">BDT '.$orderDetails['grand_total'].'</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
