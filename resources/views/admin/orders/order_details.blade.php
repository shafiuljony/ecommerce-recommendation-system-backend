            ...
            <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    ...
                    <h6 class="font-weight-normal mb-0">
                      <a href="{{ url('admin/orders') }}">Back To Order</a>
                    </h6>
                </div>
                ...
                <div class="card-body">
                  <h4 class="card-title">Order Details</h4>
                    ...
                    <div class="form-group" style="height: 15px;">
                      ...
                      <label>Tk.{{ $orderDetails['grand_total'] }}</label>
                    </div>
                    <div class="form-group" style="height: 15px;">
                      <label style="font-weight: 550;">Shipping Charges: </label>
                      <label>Tk.{{ $orderDetails['shipping_charges'] }}</label>
                    </div>
                    @if(!empty($orderDetails['coupon_code']))
                        ...
                        <label>Tk.{{ $orderDetails['coupon_amount'] }}</label>
                        </div>
                    @endif
                    <div class="form-group" style="height: 15px;">
