...
class CouponsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $couponRecords = [
            ...
            ['id'=>2,'vendor_id'=>9,'coupon_option'=>'Manual','coupon_code'=>'test20','categories'=>1,'users'=>'','coupon_type'=>'Single','amount_type'=>'Percentage','amount'=>10,'expiry_date'=>'2022-12-31','status'=>1]
        ];
